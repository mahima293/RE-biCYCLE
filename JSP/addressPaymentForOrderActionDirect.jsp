<%-- 
    Document   : addressPaymentForOrderActionDirect
    Created on : 21 Apr, 2022, 10:02:00 PM
    Author     : Nancy
--%>
...
<%
    ...
    try{
            ...
            PreparedStatement ps=new P.Dbcon().con.prepareStatement("update cart_details set hostel_name=?,room_no=?,contach_no=?,orderdate=CURRENT_DATE,deliverydate='"+cd2+"', payment_method=?,account_no=?,status=? where s_id=? and b_id="+b_id+" and (status='' or status='bill')");
