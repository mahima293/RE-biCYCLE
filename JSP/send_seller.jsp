...
window.onunload = function () { null };
    ...
    <body>
        ...
        <div class="a">
            ...
            %>
            <form action="${pageContext.request.contextPath}/ProductOperationServlet" onsubmit="return validate()" method="post" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="file" name="image" id="file" onchange="return fileValidation()" required><div id="s2"></div></td>
                    </tr>
                </table>
            </div>
            <div class="d">
